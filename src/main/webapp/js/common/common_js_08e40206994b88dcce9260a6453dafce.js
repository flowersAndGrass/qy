...
ce.Callbacks = function(e) {
		...
		if(f.setAttribute("className", "t"), f.innerHTML = "  <link/><table></table><a href='#'>a</a><input type='checkbox'/>", n = f.getElementsByTagName("*") || [], r = f.getElementsByTagName("a")[0], !r || !r.style || !n.length) return t;
		...
		at.optgroup = at.option, at.tbody = at.tfoot = at.colgroup = at.caption = at.thead, at.th = at.td, ce.fn.extend({
					...
					domManip: function(e, t, n) {
						...
						if("undefined" == typeof define) {
							...
							"undefined" != typeof require && !G(require) && (r = require, require = void 0), h = requirejs = function(e, t, n, r) {
								...
								e()
							}, require || (require = h), h.version = "../js/common/2.1.11", h.jsExtRegExp = /^\/|:|\?|\.js$/, h.isBrowser = z, x = h.s = {
								contexts: F,
								newContext: ha
					...
					! function() {
						...
						define.amd = !1, requirejs.config({
							...
							window.qyerUtil = {
								...
								includeGA: function() {
									window._gaq = window._gaq || [], window._gaq.push(["_setAccount", "UA-185023-1"], ["_setDomainName", "#"], ["_setSiteSpeedSampleRate", 10], ["_addIgnoredRef", "#"], ["_addOrganic", "soso", "w"], ["_addOrganic", "sogou", "query"], ["_addOrganic", "baidu", "word"], ["_addOrganic", "baidu", "q1"], ["_addOrganic", "baidu", "q2"], ["_addOrganic", "m.baidu", "word"], ["_addOrganic", "#", "q"], ["_addOrganic", "so", "q"], ["_addOrganic", "baidu", "w"], ["_addOrganic", "#", "q"], ["_addOrganic", "sm", "q"], ["_trackPageview"]), requirejs("https:" == document.location.protocol ? ["#"] : ["../js/base_beacon_ga-1.js" /*tpa=../js/base_beacon_ga.js*/ ])
								},
								...
								_initHead: function() {
									"#" == window.location.hostname && e(".qyer_header_bg").css("position", "fixed")
								},
								_head: null,
								_getHead: function() {
								...
								ajaxFillter: function(e, t, n) {
									if(0 != window.location.href.indexOf("#") && "object" == typeof e && e.extra && e.extra.code) switch(0 | e.extra.code) {
										case 1:
								...
								doAjax: function(t) {
									...
									if(/static.qyer.com/.test(o) === !0) {
										...
										s = e.extend({}, s, {
											__qFED__: t.__qFED__
										}), t.__qFED__ && t.__qFED__.id && (l = t.__qFED__.id, t.type = "GET"), a = "#" + l, u = "jsonp", api = null
									}
									var c = e.ajax({
										type: t.type || "POST",
										url: a,
								...
								spam_text_filter: function() {
									...
									t = /(http:\/\/)?[\w\.]*\.?(mafengwo\.cn|mafengwo\.com|mafengwo\.net)[a-zA-Z\/0-9&\?\.#\-_]*/gim, o = e(".qyer_spam_text_filter"), o.find("a").each(function() {
										n = e(this), (n.html() + n.attr("href")).indexOf("#") == -1 && (n.html() + n.attr("href")).indexOf("#") == -1 && (n.html() + n.attr("href")).indexOf("#") == -1 || n.replaceWith(e(this).html())
									}), o.each(function() {
					...
					$(function() {
						...
						function t(t) {
							...
							/^http:\/\/bbs\.qyer\.com\//.test(window.location.href) && (s = "#"), jQuery.ajax({
								type: "POST",
								url: s,
								data: a,
								dataType: "json",
